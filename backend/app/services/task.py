...
class TaskService:
    ...
    async def get_user_tasks(
        ...
        # Build base query
        stmt = select(Task).join(Task.project).join(ProjectMember).where(
    ...
    async def create_task(
        ...
        logger.info("Task created", task_id=task.id, creator_id=creator_id, project_id=task_data.project_id)
        return task
    ...
    async def assign_task(
        ...
        logger.info("Task assigned", task_id=task_id, assignee_id=assignee_id, assigned_by=user_id)
        return task
    ...
    async def update_task_status(
        ...
        logger.info("Task status updated", task_id=task_id, status=status, user_id=user_id)
        return task
    ...
    async def add_task_comment(
        ...
        logger.info("Task comment added", comment_id=comment.id, task_id=task_id, user_id=user_id)
        return comment
    ...
    async def get_task_comments(
        ...
        ).order_by(TaskComment.created_at.desc()).offset(skip).limit(limit)
