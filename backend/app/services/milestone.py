...
class MilestoneService:
    ...
    async def get_project_milestones(
        ...
        ).group_by(Milestone.id).order_by(Milestone.due_date).offset(skip).limit(limit)
    ...
    async def get_milestone_by_id(
        ...
        stmt = select(Milestone).join(ProjectMember).where(
    ...
    async def create_milestone(
        ...
        logger.info("Milestone created", milestone_id=milestone.id, creator_id=creator_id, project_id=milestone_data.project_id)
        return milestone
    ...
    async def add_task_to_milestone(
        ...
        logger.info("Task added to milestone", task_id=task_id, milestone_id=milestone_id, user_id=user_id)
        return task
    ...
    async def remove_task_from_milestone(
        ...
        logger.info("Task removed from milestone", task_id=task_id, milestone_id=milestone_id, user_id=user_id)
        return task
    ...
    async def get_upcoming_milestones(
        ...
        ).order_by(Milestone.due_date).limit(limit)
