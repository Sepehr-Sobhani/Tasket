...
class NotificationService:
    ...
    async def create_notification(
        ...
        logger.info(
            "Notification created", notification_id=notification.id, user_id=user_id
        )
        return notification

    async def create_task_assigned_notification(
        self, task_id: int, assignee_id: int, project_id: int
    ):
    ...
    async def create_comment_notification(
        self, comment_id: int, task_id: int, project_id: int, mentioned_users: list[int]
    ):
        from app.models.project import Project
