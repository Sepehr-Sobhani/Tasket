...
def upgrade() -> None:
    ...
    sa.Column('title', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('status', sa.Enum('DRAFT', 'IN_PROGRESS', 'REVIEW', 'DONE', name='taskstatus'), nullable=True),
    ...
    op.create_index(op.f('ix_task_estimates_id'), 'task_estimates', ['id'], unique=False)
